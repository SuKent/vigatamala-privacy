...
public enum AdblockRuleConverter {
    ...
    ///   (大清單不進 bundle)。
    /// - **為什麼是 65,000 而不是 150,000。** 上游今天轉出來是 60,928 與
    ///   55,895,65,000 對兩份都是**零截斷**。餘裕約 6.7%(EasyList 還可以
    ///   再長約 4,000 條)—— 比 75,000 緊,所以 RuleBundler 加了一道
    ///   「這次真的被上限砍到」的明顯警告,餘裕用完不會是無聲的。
    ...
    public static let defaultLimit = 65_000
